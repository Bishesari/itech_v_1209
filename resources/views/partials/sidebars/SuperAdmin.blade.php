...
<flux:navlist.group :heading="__('آزمونها')" class="grid" expandable :expanded="request()->routeIs(['exams', 'exam_create'])" >
    <flux:navlist.item icon="user-group" href="{{route('exams')}}" :current="request()->routeIs('exams')" wire:navigate>{{ __('لیست آزمون') }}</flux:navlist.item>
